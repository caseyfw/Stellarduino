...
static const ROCK rocks[N_ROCKS] = {
   ...
   {  618,             /* Pan: SAT353  */
      2451545.000000000,                    /* element epoch Julian date     */
       1.335849665747076E+05,               /* a = semi-major axis (km)      */
       1.604781133142380E-06,               /* h = e sin(periapsis longitude)*/
      -3.313066563799880E-06,               /* k = e cos(periapsis longitude)*/
       1.465933402582515E+02 * PI / 180.,   /* l = mean longitude (deg)      */
       2.275060147452053E-06,               /* p = tan(i/2) sin(node)        */
       1.740340403152003E-06,               /* q = tan(i/2) cos(node)        */
       3.711667872388040E-05 * PI / 180.,   /* apsis rate (deg/sec)          */
       7.245737663543955E-03 * PI / 180.,   /* mean motion (deg/sec)         */
      -3.692848975480782E-05 * PI / 180.,   /* node rate (deg/sec)           */
   ...
   {  635,             /* Daphnis: SAT353  */
      2451545.0,                            /* element epoch Julian date     */
       1.365040941809025E+05,               /* a = semi-major axis (km)      */
       9.826554090945180E-06,               /* h = e sin(periapsis longitude)*/
       1.179908217074106E-05,               /* k = e cos(periapsis longitude)*/
       1.535879301710556E+02 * PI / 180.,   /* l = mean longitude (deg)      */
       1.793347801180179E-05,               /* p = tan(i/2) sin(node)        */
      -1.664479721758035E-05,               /* q = tan(i/2) cos(node)        */
       3.436678549370743E-05 * PI / 180.,   /* apsis rate (deg/sec)          */
       7.013647583529643E-03 * PI / 180.,   /* mean motion (deg/sec)         */
      -3.420001209348275E-05 * PI / 180.,   /* node rate (deg/sec)           */
       4.058266021370071E+01 * PI / 180.,   /* Laplacian plane pole ra (deg) */
       8.353762557532015E+01 * PI / 180. }, /* Laplacian plane pole dec (deg)*/
