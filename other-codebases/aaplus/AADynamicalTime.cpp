...
{
//All the initial values are observed values from 1 February 1973 to 1 April 2012 as taken from http://maia.usno.navy.mil/ser7/deltat.data 
  { 2441714.5,	43.4724 },
  { 2441742.5,	43.5648 },
  { 2441773.5,	43.6737 },
  { 2441803.5,	43.7782 },
...
//All these final values are predicted values from Year 2012.50 to Year 2021 as taken from http://maia.usno.navy.mil/ser7/deltat.preds
  { 2456110.50, 66.761  },   
  { 2456202.00, 66.792  }, 
  { 2456293.50, 67.1    },
  { 2456384.75, 67.2    },
...
//Note we do not use these values and instead revert back to the Espenak & Meeus 2006 algorithm at this point i.e (years >= 2015.25). This 
//helps avoid as many discontinuities in the DeltaT graph as possible. As currently coded there is a single discontinuity of c.
//one second in early April 2015. At this point http://maia.usno.navy.mil/ser7/deltat.preds indicates an error value for DeltaT of about 0.9
//seconds anyway
/* 
  { 2457206.00, 68      },
  { 2457297.25, 68      },
